...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            console.log('🚀 Создаем пагинацию для удаления событий...');
            await createPagination(25, interaction, mappedEvents, 'event-select-delete', client, 'Выберите ивент для удаления');
            console.log('✅ Пагинация для удаления создана');
            
        } catch (error) {
            console.error('❌ Ошибка при создании пагинации для удаления:', error);
            try {
